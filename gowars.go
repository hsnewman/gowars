...
<div id="mobile-panel">
  ...
  <div id="enter-row">
    <button class="num-btn num-enter yellow-btn" style="width:50%;" onclick="triggerSpacebar()">Space</button>
    <button class="num-btn num-enter yellow-btn" style="width:50%;" onclick="sendRaw('\r')">&#9166; Enter</button>
  </div>
</div>
